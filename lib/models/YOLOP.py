...
from lib.models.common import Conv, SPP, Bottleneck, BottleneckCSP, Focus, Concat, Detect, SharpenConv , LaneNet
...
#from common import LaneNet



# The lane line and the driving area segment branches without share information with each other and without link
YOLOP = [
[24, 33, 42, 16, 43],   #Det_out_idx, Da_Segout_idx, LL_Segout_idx , neck_out_idx
[ -1, Focus, [3, 32, 3]],   #0
[ -1, Conv, [32, 64, 3, 2]],    #1
...
class MCnet(nn.Module):
    def __init__(self, block_cfg, **kwargs):#block_cfg = yolop
        ...
        for i, (from_, block, args) in enumerate(block_cfg[1:]): 
            ...
            # i=0 (from_=-1 block=Focus args=[3,32,3]) 
